...
$sql_historial = "SELECT h.id_libro, h.fecha_termino, l.titulo, l.autor
                  FROM historial h
...
<head>
    ...
    <title>BiblioTecaTeca | En poder</title>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-text">Entrega: <?php echo $row_historial['fecha_termino']; ?></h6>
